...
\textit{Aveparvovirus} is a new genus within the \textit{Parvovirinae} subfamily that comprises the species chicken parvovirus and turkey parvovirus. The name \textit{Aveparvovirus} is derived from \underline{av}ian parvoviruses, referring to the hosts from which the members were isolated. Although those viruses have been identified for years in the intestinal tracts of poultry \cite{pmid18766849, pmid6847550}, analysis of the complete nucleotide sequence has been reported only recently \cite{pmid20097398, pmid25510852}.   
