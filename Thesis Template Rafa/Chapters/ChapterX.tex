...
\section{Nucleofection}
NB324K cells at a confluence of 70 \% were trypsinized and resuspended in 10 mL of DMEM (see Table~\ref{Media}, p.~\pageref{Media}) supplemented with 10 \% FCS. A total amount of 10\textsuperscript{6} NB324K cells were nucleofected using the AMAXA\textsuperscript{\texttrademark} nucleofector\textsuperscript{\texttrademark}~\RM{2} device (Lonza) following the manufacturer’s instructions. Nucleofection was carried out with 5 $\mu$g of the infectious clone of MVM \cite{pmid6345805} using the V-001 program. As a nucleofection reagent, AMAXA\textsuperscript{\textregistered} Cell Line Nucleofector\textsuperscript{\textregistered} Kit V (see Table~\ref{Kits}, p.~\pageref{Kits}) was used. Following the electric pulse the weakened cells were maintained in 1.5 mL of pre-warmed culture medium in 6-well plates. When the surviving cells became adherent approximately 6 hpt, the culture medium was carefully replaced by the equal amount of pre-warmed fresh culture medium. The cells were further incubated for the required times.        
